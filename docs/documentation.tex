...
\end{call}
\mess{login}{if exception: sendError}{client}
...
\end{call}
\mess{reg}{if exception: sendError}{client}
\end{call}
\end{sequencediagram}
}
...
\begin{sequencediagram}
	...
	\newinst[5]{login}{Login}
	\newinst[4]{dao}{UserDAO}
	\begin{call}{client}{click login button}{client}{}
...
\begin{sequencediagram}
	...
	\newinst[4]{dao}{UserDAO}
		\begin{call}{client}{click sign up button}{client}{}
